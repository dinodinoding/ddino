...
class GUI_App(QWidget):
    ...
    def init_ui(self):
        ...
        self.console_output.setMaximumBlockCount(500)  # keep last 500 lines
    ...
    def load_settings(self):
        ...
        if os.path.exists(config_path):
            try:
                ...
                self.status_label.setText(f"Status: Error loading settings.")
        else:
    ...
    def stop_monitoring(self):
        ...
        self.console_output.appendPlainText("Worker stopped.")

    def closeEvent(self, event):
        # GUI 닫아도 worker는 계속 실행
        event.accept()
